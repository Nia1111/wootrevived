...
<ItemImage id="fluid_infuser" scale="0.5"/>液体注入機は、液体にアイテムを注入することで別の液体を生成することができます。
...
<ItemImage id="mob_tears_fluid_bucket" scale="0.5"/>モブの涙液は、<ItemImage id="vitality_fuel_fluid_bucket" scale="0.5"/>バイタリティ燃料液をを生成するために使用されます。また、<ItemImage id="item_infuser" scale="0.5"/> [アイテム注入機](item-infuser.md)を使用して、特定のアイテムをクラフトする際にも利用できます。
...
<ItemImage id="vitality_fuel_fluid_bucket" scale="0.5"/>バイタリティ燃料液はファクトリーの燃料であり、モブをシミュレートするために必要です。
