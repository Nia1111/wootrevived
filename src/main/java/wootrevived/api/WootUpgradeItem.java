 ...
 * {@link DynamicUpgradeItemModelBuilder}. Variant-specific rendering remains
 * optional.</p>
 *
 ...
 * For data generators, {@link DynamicUpgradeItemModelBuilder} enables
...
public abstract class WootUpgradeItem<T extends Enum<T> & WootUpgradeEnum<T>> extends Item {
     ...
     *
     * @return an {@link ItemInteractionResult} indicating whether the action was handled
     */
    public @NotNull ItemInteractionResult interact(@NotNull MutableDataComponentHolder dataComponentHolder, @NotNull ItemStack stack, @NotNull Level level, @NotNull Player player, @NotNull InteractionHand hand, @NotNull BlockHitResult hit){
