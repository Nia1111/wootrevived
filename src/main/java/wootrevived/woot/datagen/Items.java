...
public class Items extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        itemGenerated(ItemsRegistry.WHITE_DYE_PLATE_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_plate"));
        itemGenerated(ItemsRegistry.ORANGE_DYE_PLATE_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_plate"));
        itemGenerated(ItemsRegistry.MAGENTA_DYE_PLATE_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_plate"));
        itemGenerated(ItemsRegistry.LIGHT_BLUE_DYE_PLATE_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_plate"));
        itemGenerated(ItemsRegistry.YELLOW_DYE_PLATE_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_plate"));
        itemGenerated(ItemsRegistry.LIME_DYE_PLATE_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_plate"));
        itemGenerated(ItemsRegistry.PINK_DYE_PLATE_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_plate"));
        itemGenerated(ItemsRegistry.GRAY_DYE_PLATE_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_plate"));
        itemGenerated(ItemsRegistry.LIGHT_GRAY_DYE_PLATE_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_plate"));
        itemGenerated(ItemsRegistry.CYAN_DYE_PLATE_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_plate"));
        itemGenerated(ItemsRegistry.PURPLE_DYE_PLATE_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_plate"));
        itemGenerated(ItemsRegistry.BLUE_DYE_PLATE_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_plate"));
        itemGenerated(ItemsRegistry.BROWN_DYE_PLATE_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_plate"));
        itemGenerated(ItemsRegistry.GREEN_DYE_PLATE_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_plate"));
        itemGenerated(ItemsRegistry.RED_DYE_PLATE_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_plate"));
        itemGenerated(ItemsRegistry.BLACK_DYE_PLATE_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_plate"));

        itemGenerated(ItemsRegistry.WHITE_DYE_CASING_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_casing"));
        itemGenerated(ItemsRegistry.ORANGE_DYE_CASING_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_casing"));
        itemGenerated(ItemsRegistry.MAGENTA_DYE_CASING_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_casing"));
        itemGenerated(ItemsRegistry.LIGHT_BLUE_DYE_CASING_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_casing"));
        itemGenerated(ItemsRegistry.YELLOW_DYE_CASING_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_casing"));
        itemGenerated(ItemsRegistry.LIME_DYE_CASING_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_casing"));
        itemGenerated(ItemsRegistry.PINK_DYE_CASING_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_casing"));
        itemGenerated(ItemsRegistry.GRAY_DYE_CASING_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_casing"));
        itemGenerated(ItemsRegistry.LIGHT_GRAY_DYE_CASING_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_casing"));
        itemGenerated(ItemsRegistry.CYAN_DYE_CASING_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_casing"));
        itemGenerated(ItemsRegistry.PURPLE_DYE_CASING_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_casing"));
        itemGenerated(ItemsRegistry.BLUE_DYE_CASING_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_casing"));
        itemGenerated(ItemsRegistry.BROWN_DYE_CASING_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_casing"));
        itemGenerated(ItemsRegistry.GREEN_DYE_CASING_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_casing"));
        itemGenerated(ItemsRegistry.RED_DYE_CASING_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_casing"));
        itemGenerated(ItemsRegistry.BLACK_DYE_CASING_ITEM, ResourceLocation.tryBuild(Woot.MOD_ID, "item/dye_casing"));
