...
public class Mass extends WootUpgradeItem {
    ...
    public static final RegistryObject<Mass> COPPER_MASS_ITEM = ITEMS.register(COPPER_MASS_TAG, () -> new Mass(1));

    public static final String IRON_MASS_TAG = "iron_mass_upgrade";
    public static final RegistryObject<Mass> IRON_MASS_ITEM = ITEMS.register(IRON_MASS_TAG, () -> new Mass(2));

    public static final String GOLD_MASS_TAG = "gold_mass_upgrade";
    public static final RegistryObject<Mass> GOLD_MASS_ITEM = ITEMS.register(GOLD_MASS_TAG, () -> new Mass(3));

    public static final String DIAMOND_MASS_TAG = "diamond_mass_upgrade";
    public static final RegistryObject<Mass> DIAMOND_MASS_ITEM = ITEMS.register(DIAMOND_MASS_TAG, () -> new Mass(4));

    public static final String NETHERITE_MASS_TAG = "netherite_mass_upgrade";
    public static final RegistryObject<Mass> NETHERITE_MASS_ITEM = ITEMS.register(NETHERITE_MASS_TAG, () -> new Mass(5));
}
