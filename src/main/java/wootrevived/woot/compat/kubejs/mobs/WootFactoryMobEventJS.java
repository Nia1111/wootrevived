...
public class WootFactoryMobEventJS implements KubeStartupEvent {
    ...
    public static class FactoryMobBuilderJS<T extends Entity> {
        ...
        public FactoryMobBuilderJS<T> setImportItems(ItemStack[] items){
            importItems.clear();
            importItems.addAll(Arrays.stream(items).toList());
            return this;
        }

        public FactoryMobBuilderJS<T> setImportFluids(FluidStack[] fluids){
            importFluids.clear();
            importFluids.addAll(Arrays.stream(fluids).toList());
            return this;
        }
