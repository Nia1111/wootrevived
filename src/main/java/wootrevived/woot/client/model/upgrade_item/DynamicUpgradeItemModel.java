...
public class DynamicUpgradeItemModel implements IUnbakedGeometry<DynamicUpgradeItemModel> {
    ...
    public BakedModel bake(IGeometryBakingContext context, ModelBaker baker, Function<Material, TextureAtlasSprite> spriteGetter, ModelState modelState, ItemOverrides overrides) {
        ...
        return bake(entry, context, baker, spriteGetter, modelState, overrides);
    }

    public <T extends Enum<T> & WootUpgradeEnum<T>> BakedModel bake(UpgradeItemsRegistry.DynamicEntry<T> entry, IGeometryBakingContext context, ModelBaker baker, Function<Material, TextureAtlasSprite> spriteGetter, ModelState modelState, ItemOverrides overrides) {
