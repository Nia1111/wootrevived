...
public class ItemsRegistry {
    ...
    public static final DeferredHolder<Item, BasicItem> STYGIAN_INGOT_ITEM = ITEMS.register(STYGIAN_INGOT_TAG, () -> new BasicItem(BasicItem.Type.STYGIAN_PLATE));

    public static final String STYGIAN_DUST_TAG = "stygian_dust";
    public static final DeferredHolder<Item, BasicItem> STYGIAN_DUST_ITEM = ITEMS.register(STYGIAN_DUST_TAG, () -> new BasicItem(BasicItem.Type.STYGIAN_DUST));

    public static final String STYGIAN_PLATE_TAG = "stygian_plate";
    public static final DeferredHolder<Item, BasicItem> STYGIAN_PLATE_ITEM = ITEMS.register(STYGIAN_PLATE_TAG, () -> new BasicItem(BasicItem.Type.STYGIAN_PLATE));

    public static final String STYGIAN_HAMMER_TAG = "stygian_hammer";
    public static final DeferredHolder<Item, StygianHammerItem> STYGIAN_HAMMER_ITEM = ITEMS.register(STYGIAN_HAMMER_TAG, StygianHammerItem::new);

    /* Molds */

    public static final String PLATE_MOLD_TAG = "plate_mold";
    public static final DeferredHolder<Item, MoldItem> PLATE_MOLD_ITEM = ITEMS.register(PLATE_MOLD_TAG, () -> new MoldItem(MoldItem.MoldType.PLATE));

    public static final String SHARD_MOLD_TAG = "shard_mold";
    public static final DeferredHolder<Item, MoldItem> SHARD_MOLD_ITEM = ITEMS.register(SHARD_MOLD_TAG, () -> new MoldItem(MoldItem.MoldType.SHARD));

    public static final String DYE_CASING_MOLD_TAG = "dye_casing_mold";
    public static final DeferredHolder<Item, MoldItem> DYE_CASING_MOLD_ITEM = ITEMS.register(DYE_CASING_MOLD_TAG, () -> new MoldItem(MoldItem.MoldType.DYE_CASING));

    /* Prism */

    public static final String PRISM_TAG = "prism";
    public static final DeferredHolder<Item, BasicItem> PRISM_ITEM = ITEMS.register(PRISM_TAG, () -> new BasicItem(BasicItem.Type.PRISM));

    /* Mob Shard */

    public static final String MOB_SHARD_TAG = "mob_shard";
    public static final DeferredHolder<Item, MobShardItem> MOB_SHARD_ITEM = ITEMS.register(MOB_SHARD_TAG, MobShardItem::new);
    public static final DeferredHolder<EntityType<?>, EntityType<MobShardProjectile>> MOB_SHARD_PROJECTILE = ENTITY_TYPES.register(MOB_SHARD_TAG, () -> EntityType.Builder.<MobShardProjectile>of(MobShardProjectile::new, MobCategory.MISC).sized(0.5f, 0.5f).build(MOB_SHARD_TAG));

    /* Xp Shard & Splinter */

    public static final String XP_SHARD_TAG = "xp_shard";
    public static final DeferredHolder<Item, XpItem> XP_SHARD_ITEM = ITEMS.register(XP_SHARD_TAG, () -> new XpItem(XpItem.Variant.SHARD));

    public static final String XP_SPLINTER_TAG = "xp_splinter";
    public static final DeferredHolder<Item, XpItem> XP_SPLINTER_ITEM = ITEMS.register(XP_SPLINTER_TAG, () -> new XpItem(XpItem.Variant.SPLINTER));

    /* Tier Shards */

    public static final String COPPER_SHARD_TAG = "copper_shard";
    public static final DeferredHolder<Item, BasicItem> COPPER_SHARD_ITEM = ITEMS.register(COPPER_SHARD_TAG, () -> new BasicItem(BasicItem.Type.COPPER_SHARD));

    public static final String IRON_SHARD_TAG = "iron_shard";
    public static final DeferredHolder<Item, BasicItem> IRON_SHARD_ITEM = ITEMS.register(IRON_SHARD_TAG, () -> new BasicItem(BasicItem.Type.IRON_SHARD));

    public static final String GOLD_SHARD_TAG = "gold_shard";
    public static final DeferredHolder<Item, BasicItem> GOLD_SHARD_ITEM = ITEMS.register(GOLD_SHARD_TAG, () -> new BasicItem(BasicItem.Type.GOLD_SHARD));

    public static final String DIAMOND_SHARD_TAG = "diamond_shard";
    public static final DeferredHolder<Item, BasicItem> DIAMOND_SHARD_ITEM = ITEMS.register(DIAMOND_SHARD_TAG, () -> new BasicItem(BasicItem.Type.DIAMOND_SHARD));

    public static final String NETHERITE_SHARD_TAG = "netherite_shard";
    public static final DeferredHolder<Item, BasicItem> NETHERITE_SHARD_ITEM = ITEMS.register(NETHERITE_SHARD_TAG, () -> new BasicItem(BasicItem.Type.NETHERITE_SHARD));

    /* Tier Enchanted Plates */

    public static final String COPPER_ENCHANTED_PLATE_TAG = "copper_enchanted_plate";
    public static final DeferredHolder<Item, BasicItem> COPPER_ENCHANTED_PLATE_ITEM = ITEMS.register(COPPER_ENCHANTED_PLATE_TAG, () -> new BasicItem(BasicItem.Type.COPPER_ENCHANTED_PLATE));

    public static final String IRON_ENCHANTED_PLATE_TAG = "iron_enchanted_plate";
    public static final DeferredHolder<Item, BasicItem> IRON_ENCHANTED_PLATE_ITEM = ITEMS.register(IRON_ENCHANTED_PLATE_TAG, () -> new BasicItem(BasicItem.Type.IRON_ENCHANTED_PLATE));

    public static final String GOLD_ENCHANTED_PLATE_TAG = "gold_enchanted_plate";
    public static final DeferredHolder<Item, BasicItem> GOLD_ENCHANTED_PLATE_ITEM = ITEMS.register(GOLD_ENCHANTED_PLATE_TAG, () -> new BasicItem(BasicItem.Type.GOLD_ENCHANTED_PLATE));

    public static final String DIAMOND_ENCHANTED_PLATE_TAG = "diamond_enchanted_plate";
    public static final DeferredHolder<Item, BasicItem> DIAMOND_ENCHANTED_PLATE_ITEM = ITEMS.register(DIAMOND_ENCHANTED_PLATE_TAG, () -> new BasicItem(BasicItem.Type.DIAMOND_ENCHANTED_PLATE));

    public static final String NETHERITE_ENCHANTED_PLATE_TAG = "netherite_enchanted_plate";
    public static final DeferredHolder<Item, BasicItem> NETHERITE_ENCHANTED_PLATE_ITEM = ITEMS.register(NETHERITE_ENCHANTED_PLATE_TAG, () -> new BasicItem(BasicItem.Type.NETHERITE_ENCHANTED_PLATE));
    ...
    public static final DeferredHolder<Item, GuideBookItem> GUIDE_BOOK_ITEM = ITEMS.register(GUIDE_BOOK_TAG, GuideBookItem::new);
}
